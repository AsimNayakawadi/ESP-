...
// Wi-Fi credentials
const char* ssid     = "E-OpenCampus01";
const char* password = "8wN$AhNC)Z4F";

// Server info
const char* server = "http://campusdayapp.germanywestcentral.cloudapp.azure.com/api/station/check";
